...
# Save if you want
model.save('mobilenetv2_dropout_0.5.h5')
...
tuned_mobilenetv2 = load_model('mobilenetv2_dropout_0.5.h5')  # or your filename

evaluate_model(tuned_mobilenetv2, "mobilenetv2_dropout_0.5", test_generator)
