...
"""##Train the Custom CNN Model and Save Artifacts"""
...
models = {}
models["Tuned_VGG16"] = load_model("saved_models/Tuned_VGG16.keras")
models["Tuned_MobileNetV2"] = load_model("saved_models/Tuned_MobileNetV2.keras")
models["Tuned_ResNet50"] = load_model("saved_models/Tuned_ResNet50.keras")

# STEP 4: Evaluate All Tuned Models
evaluate_model(models["Tuned_VGG16"], "Tuned_VGG16", test_generator)
evaluate_model(models["Tuned_MobileNetV2"], "Tuned_MobileNetV2", test_generator)
evaluate_model(models["Tuned_ResNet50"], "Tuned_ResNet50", test_generator)

"""##Build, Train, and Save a Tuned Custom CNN Model with Adjustable Hyperparameters"""
...
models = {
    ...
    "Tuned_VGG16": models["Tuned_VGG16"],
    "Tuned_MobileNetV2": models["Tuned_MobileNetV2"],
    "Tuned_ResNet50": models["Tuned_ResNet50"]
}
